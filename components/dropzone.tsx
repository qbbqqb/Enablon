    ...
    <div className="w-full">
      <div
        className={`
          ...
          ${isDragOver && !disabled ? 'border-primary bg-primary/5 scale-[1.01]' : 'border-border'}
          ${disabled ? 'bg-muted cursor-not-allowed opacity-50' : 'hover:border-primary/50 hover:bg-primary/5 cursor-pointer'}
          ${files.length > 0 ? 'border-green-400 dark:border-green-600 bg-green-50/50 dark:bg-green-950/20' : ''}
        `}
          ...
          <div className="bg-card border border-border rounded-lg overflow-hidden">
            <div className="px-4 py-3 bg-muted border-b border-border flex justify-between items-center">
              ...
              <button
                onClick={clearFiles}
                disabled={disabled}
                className="text-sm text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 disabled:text-muted-foreground flex items-center space-x-1"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div key={index} className="border border-border rounded-lg p-3 hover:bg-muted/50 transition-colors">
                    <div className="flex items-center space-x-3">
                      ...
                      <button
                        ...
                        disabled={disabled}
                        className="w-6 h-6 rounded-full bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
                        title="Remove photo"
                      >
            ...
            <div className="px-4 py-2 bg-green-50 dark:bg-green-950/30 border-t border-border">
              <div className="flex items-center justify-between text-sm">
                <span className="text-green-700 dark:text-green-400 font-medium">Ready for processing</span>
